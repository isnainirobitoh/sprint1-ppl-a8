...
if( isset($_POST["login"]) ) {
    ...
    $qry = $conn->query("SELECT * FROM cust WHERE email = '$email' AND password = '$password'");
    $cek = $qry->num_rows;
    // cek email
    if( $cek > 0) {
...
<div class="container">
    ...
    <form action="" method="post">
        ...
        <a href="registrasiverif.php" class="clickme">Registrasi</a>
        <a href="lupapassword.php" class="clickme">Lupa Password?</a>
        <br>
        <br>
        </fieldset>
