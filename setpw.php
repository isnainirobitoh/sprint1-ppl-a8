...
if( !isset($_SESSION["lupapassword"]) || !isset($_SESSION["user_id"]) ) {
    header("Location: lupapassword.php");
    exit;
}

$user_id = $_SESSION['user_id'];
$query = mysqli_query($conn, "SELECT * FROM cust WHERE id = $user_id");
...
if (isset($_POST['setpw'])) {
    ...
    $query = "UPDATE cust SET password = '$password' WHERE id = $user_id";
    ...
    <div class="container">
        ...
        <form action="" method="post">
            ...
            <div class=btn-profil>
                <button type="submit" name="setpw">KIRIM</button>
            </div>
        </form>
        </div>
    </div>
